...
/**
 * @brief Write string data in log.
 * 
 * @param data Data to be written.
 * @param addr Data address.
 * @return true - Operation success. 
 */
bool cfg::Log::write(String data, uint8_t addr)
{
...
/**
 * @brief Read string data in log. 
 * 
 * @param addr Data address.
 * @return String data in the address.
 */
String cfg::Log::reads(uint8_t addr) { return EEPROM.readString(addr); }