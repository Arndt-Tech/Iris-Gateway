...
String randomize_ID_BT()
{
  ...
  return String("GateIRIS - " + String(random(9999), DEC));
}
...
{
  writeBT("~");    // Pode enviar SSID
  
  Serial.println ("SSID");
  SSID_STR = getData();
  Serial.println ("SSID: " + String (SSID_STR));
  delay (1000);
}
...
{
  writeBT("^");    // Pode enviar SENHA
  
  Serial.println ("SENHA");
  PASSWORD_STR = getData();
  Serial.println ("PASS: " + String (PASSWORD_STR));
  delay (1000);
...
//-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
void getIDs_Firebase() // Recebe ID's via bluetooth
{
  Serial.println ("USER_ID");
  writeBT("/");    // Pode enviar ID de usuário
  USER_ID_STR = getData();
...
//-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
void getWifi()  // Recebe SSID do wifi via bluetooth
{
  delay (1300);
  waitingSSID_WIFI();
  waitingPASSWORD_WIFI();
}
